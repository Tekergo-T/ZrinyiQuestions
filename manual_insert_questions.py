...
QUESTIONS = [
    ...
    },
    {
        ...
        "difficulty": "hard",
        "correct": "C",
        "options": ["4", "5", "6", "7", "Nem lehet"],
        "question": "Van egy 5 literes és egy 3 literes üres vödröd. Nincs rajtuk beosztás. Pontosan 4 liter vizet szeretnél kimérni. Mi a legkevesebb lépés (töltés / átöntés / kiöntés), amivel ez biztosan megoldható?",
        "comment": "1. Töltsd meg az 5 literest. 2. Önts belőle a 3 literesbe (marad 2 liter az 5-ösben). 3. Ürítsd ki a 3 literest. 4. Öntsd át a maradék 2 litert a 3 literesbe. 5. Töltsd meg újra az 5 literest. 6. Önts a 3 literesbe addig, amíg tele lesz (1 liter fér bele). Az 5 literesben pontosan 4 liter marad.",
    },
    {
        "class": "2",
        "difficulty": "hard",
        "correct": "C",
        "options": ["97", "113", "129", "131", "135"],
        "question": "Mi a következő szám? 5, 9, 17, 33, 65, ?",
        "comment": "A szabály: előző × 2 - 1. 65 × 2 - 1 = 129.",
    },
    {
        "class": "2",
        "difficulty": "hard",
        "correct": "C",
        "options": ["10", "12", "14", "16", "18"],
        "question": "Három barát életkora összeadva 30 év. Ketten közülük egyidősek. A harmadik 6 évvel idősebb náluk. Hány éves a legidősebb?",
        "comment": "Legyen a két egyidős x éves. A harmadik: x + 6. Összeg: x + x + (x + 6) = 30 -> 3x + 6 = 30 -> 3x = 24 -> x = 8. A legidősebb: 8 + 6 = 14.",
    },
    {
        "class": "2",
        "difficulty": "hard",
        "correct": "C",
        "options": ["5", "6", "7", "8", "9"],
        "question": "Egy folyón kell átvinned egy rókát, egy tyúkot és egy zsák kukoricát. Csónakba egyszerre csak egy dolgot vihetsz át. Ha a róka és a tyúk egyedül marad -> a róka megeszi. Ha a tyúk és a kukorica marad egyedül -> a tyúk megeszi. Minimum hány átkelés kell (egyik oldalrol at a masik oldalra?",
        "comment": "1. Tyúk át, 2. Vissza, 3. Róka át, 4. Tyúk vissza, 5. Kukorica át, 6. Vissza, 7. Tyúk át. Összesen 7.",
    },
    {
        "class": "2",
        "difficulty": "hard",
        "correct": "B",
        "options": ["11", "12", "13", "14", "15"],
        "question": "Egy mesekönyv oldalait 1-től kezdve megszámozták. A számozáshoz összesen 15 számjegyet használtak fel. Hány oldalas a könyv?",
        "comment": "Az 1-9 oldalakhoz 9 számjegy kell. Marad 15 - 9 = 6 számjegy. A 10. oldaltól minden oldal 2 számjegyből áll. A maradék 6 számjegy 3 oldalra elég (10, 11, 12). Tehát a könyv 12 oldalas.",
    },
    {
        "class": "2",
        "difficulty": "hard",
        "correct": "B",
        "options": ["4", "6", "8", "10", "12"],
        "question": "Négy jó barát találkozik az utcán. Mindenki mindenkivel kezet fog egyszer. Hány kézfogás történt összesen?",
        "comment": "Az 1. gyerek kezet fog a másik 3-mal (3). A 2. gyerek kezet fog a többivel (már csak 2 új). A 3. gyerek kezet fog az utolsóval (1). 3 + 2 + 1 = 6 kézfogás.",
    },
    {
        "class": "2",
        "difficulty": "hard",
        "correct": "C",
        "options": ["60", "70", "80", "90", "100"],
        "question": "Egy boltban 2 kakaóscsiga és 1 kifli 200 Ft-ba kerül. Ugyanebben a boltban 1 kakaóscsiga és 2 kifli 160 Ft-ba kerül. Mennyibe kerül 1 kakaóscsiga?",
        "comment": "Ha mindkét vásárlást összeadjuk: 3 kakaóscsiga és 3 kifli ára 200 + 160 = 360 Ft. Ebből 1 kakaóscsiga és 1 kifli ára 360 / 3 = 120 Ft. Mivel 2 kakaóscsiga és 1 kifli 200 Ft, ezért a második kakaóscsiga ára 200 - 120 = 80 Ft.",
    },
    {
        "class": "2",
        "difficulty": "hard",
        "correct": "B",
        "options": ["1 perc", "3 perc", "10 perc", "33 perc", "100 perc"],
        "question": "Ha 3 macska 3 perc alatt 3 egeret fog meg, mennyi idő alatt fog meg 100 macska 100 egeret?",
        "comment": "Ha 3 macska 3 perc alatt 3 egeret fog, az azt jelenti, hogy 1 macska 3 perc alatt fog meg 1 egeret (mindegyik macska a saját egerével van elfoglalva 3 percig). Így 100 macskának is 3 perc kell 100 egér megfogásához.",
    },
    {
        "class": "2",
        "difficulty": "hard",
        "correct": "E",
        "options": ["5", "8", "9", "10", "11"],
        "question": "Palinak és Móninak összesen 16 üveggolyója van. Ha Pali ad Móninak 3 golyót, akkor ugyanannyi golyójuk lesz. Hány golyója volt Palinak eredetileg?",
        "comment": "Amikor ugyanannyi golyójuk lesz, mindkettőnek 16 / 2 = 8 golyója van. Ahhoz, hogy Palinak 8 maradjon azután, hogy adott 3-at, eredetileg 8 + 3 = 11 golyója kellett, hogy legyen.",
    },
    {
        "class": "2",
        "comment": "Tóni megette a tojások felét (2/4) és a negyedét (1/4), ami összesen 3/4. A maradék 1/4. Az evett mennyiség (3/4) és a maradék (1/4) különbsége 2/4, azaz az összes fele. Mivel ez 10 tojás, az összes 20.",
        "correct": "B",
        "difficulty": "hard",
        "options": ["16", "20", "24", "40", "Nem meghatározható"],
        "question": "Torkos Tóni először megette a gyűjtött csokitojásainak a felét, majd a gyűjtött csokitojásainak negyedét. Ezután megállapította, hogy 10-zel kevesebb csokitojása maradt, mint amennyit megevett. Hány csokitojást gyűjtött?",
    },
    {
        "class": "2",
        "comment": "Ha a vagonok száma 20: Péter (minden 5.) 4-et számol, Nándor (minden 4.) 5-öt, Mátyás (minden 3.) 6-ot (20 : 3 = 6, maradék 2). A 4, 5, 6 egymást követő számok. 21-nél már nem stimmel.",
        "correct": "C",
        "difficulty": "hard",
        "options": ["12", "17", "20", "21", "60"],
        "question": "Három kisfiú tehervagonokat számlált: Mátyás minden harmadikat, Nándor minden negyediket, Péter minden ötödiket. Három egymás utáni egyjegyű számot kaptak eredményül. Hány vagonja volt a vonatnak, ha a számuk a lehető legtöbb?",
    },
    {
        "class": "2",
        "comment": "1 év = 12 hónap. 2 év = 2 × 12 = 24 hónap.",
        "correct": "D",
        "difficulty": "easy",
        "options": ["18", "20", "22", "24", "26"],
        "question": "Gabi 2 éve jár sakkozni. Hány hónapja jár sakkozni Gabi?",
    },
    {
        "class": "2",
        "comment": "2 méter = 20 deciméter. Ha 4 egyenlő részre törjük: 20 : 4 = 5 deciméter.",
        "correct": "D",
        "difficulty": "hard",
        "options": ["2", "3", "4", "5", "10"],
        "question": "Csiribá, a habókos mágus egy 2 méter hosszú varázspálcát az egyik varázslata során 4 egyenlő hosszúságú részre tört el. Hány deciméter hosszú darabokra tört a pálca?",
    },
    {
        "class": "2",
        "comment": "Ha az összeg 26 és Éva 12, akkor Karcsi 26 − 12 = 14 éves. A különbség 14 − 12 = 2 év.",
        "correct": "B",
        "difficulty": "medium",
        "options": ["1", "2", "3", "4", "14"],
        "question": "Évának és Karcsinak ma van a születésnapja. Éva ma 12 éves. Kettőjük életkorának összege 26 év. Hány év a korkülönbség kettőjük között?",
    },
    {
        "class": "2",
        "comment": "Sorban: 1, 2, 3, 4, 5 alma. Összesen: 1 + 2 + 3 + 4 + 5 = 15 alma.",
        "correct": "E",
        "difficulty": "medium",
        "options": ["5", "10", "11", "12", "15"],
        "question": "Piroska egyik nap egy piros almát vitt a nagymamájának. Ezután minden nap 1-gyel többet vitt, mint az előző napon. Ma 5 piros almát vitt. Hány piros almát vitt eddig összesen?",
    },
    {
        "class": "2",
        "comment": "9 harmada = 3. Melyik szám háromszorosa a 3-nak? Az 1, mert 1 × 3 = 3.",
        "correct": "A",
        "difficulty": "hard",
        "options": ["1", "2", "3", "6", "9"],
        "question": "Melyik szám háromszorosa a 9 harmada?",
    },
    {
        "class": "2",
        "comment": "Lehetséges páros számok, amelyekben a számjegyek összege 8: 26, 44, 62, 80. Ez összesen 4 darab.",
        "correct": "B",
        "difficulty": "medium",
        "options": ["3", "4", "5", "7", "9"],
        "question": "Hány olyan 0-nál nagyobb kétjegyű, páros szám van, amelyben a számjegyek összege 8?",
    },
    {
        "class": "2",
        "comment": "2 nagy doboz + (2 × 3) kicsi doboz = 2 + 6 = 8 doboz.",
        "correct": "D",
        "difficulty": "easy",
        "options": ["5", "6", "7", "8", "9"],
        "question": "Egy nagy bőröndben éppen kettő nagy doboz, és minden nagy dobozban három kicsi doboz fér el. Hány doboz fér el összesen a bőröndben?",
    },
    {
        "class": "2",
        "comment": "Peti játszmái: 4 nyert + 4 vesztett + 5 döntetlen = 13 mérkőzés.",
        "correct": "A",
        "difficulty": "easy",
        "options": ["13", "17", "18", "21", "26"],
        "question": "Peti Karcsival sakkozott. Peti 4-et nyert, 4-et veszített, és 5 mérkőzés lett döntetlen. Hány mérkőzést játszottak?",
    },
    {
        "class": "2",
        "comment": "Tévé: 24 : 3 = 8 óra. Evés: 24 : 4 = 6 óra. Alvás: 24 - 8 - 6 = 10 óra.",
        "correct": "D",
        "difficulty": "medium",
        "options": ["6", "8", "9", "10", "12"],
        "question": "Garfield a nap harmad részében tévézik, negyed részében eszik, a többi időben alszik. Hány órát alszik egy nap?",
    },
    {
        "class": "2",
        "comment": "Két kosárral 2 × 5 = 10 káposztát tud hozni egyszerre. 47 : 10 = 4, maradék 7. Tehát 5-ször kell fordulnia.",
        "correct": "B",
        "difficulty": "medium",
        "options": ["4", "5", "6", "9", "10"],
        "question": "Elek két kosárral ment a pincébe, hogy felhozzon 47 káposztát. Egy kosárba 5 káposzta fér. Legkevesebb hányszor kellett lemennie a pincébe?",
    },
    {
        "class": "2",
        "comment": "30-nak minden másodika = 15 kiásott répa. Ennek minden ötödike = 15 : 5 = 3 répa.",
        "correct": "B",
        "difficulty": "medium",
        "options": ["1", "3", "5", "10", "15"],
        "question": "Nyuszi 30 sárgarépából minden másodikat kiásta. Ezután minden ötödik kiásottat Micimackónak adott. Hány répát adott Micimackónak?",
    },
    {
        "class": "2",
        "comment": "Ha minden oldalon 5 kép volt, összesen 12 × 5 = 60. 60 - 53 = 7 hiányzik. Ez szerepel a lehetőségek között.",
        "correct": "C",
        "difficulty": "hard",
        "options": ["5", "6", "7", "8", "10"],
        "question": "Egy 12 oldalas fotóalbumból néhány kép hiányzik, most 53 van benne. Hány kép hiányozhat, ha eredetileg minden oldalon ugyanannyi kép volt?",
    },
    {
        "class": "2",
        "comment": "Összesen 13-féle csoki van (8 páros + 5 egyes). Ki vett 12-t. Hogy a legkevesebb maradjon, ki kell üríteni az 5 egyest (5 db) és 3 párost (6 db), marad 1 csoki egy újabb párosból. Így 13 - 8 = 5-féle marad.",
        "correct": "A",
        "difficulty": "hard",
        "options": ["5", "6", "7", "8", "9"],
        "question": "Artúr táskájában 21 tábla csoki volt: 8-féléből kettő-kettő, 5-féléből egy-egy. Kivett 12-t. Hányféle csoki maradt a táskában, ha ez a szám a lehető legkevesebb?",
    },
    {
        "class": "2",
        "comment": "Felső (F) = 10k + 2, alsó (A) = 9m + 3. F + A = 100. Kipróbálva: F = 52, A = 48 megfelel (52 + 48 = 100). 52 - 48 = 4-gyel több a felsőn.",
        "correct": "C",
        "difficulty": "hard",
        "options": [
            "Felső, 2-vel",
        ...
        "question": "Két vezetéken 100 fecske van. Ha a felsőt 10-esével csoportosítjuk, 2 marad ki. Ha az alsót 9-esével, 3 marad ki. Melyiken van több és mennyivel?",
    },
    {
        "class": "2",
        "comment": "16 borítékból 4 teli, 12 üres. Ha 2 üres maradt a zsákban, akkor 10 üres kikerült. Mivel 1 telit is kivett, összesen 10 + 1 = 11-et vett ki.",
        "correct": "E",
        "difficulty": "hard",
        "options": ["7", "8", "9", "10", "11"],
        "question": "Lilinek 16 borítékja volt, 4-be papírt tett. Kivett néhányat a zsákból, és 1 papírosat talált. A zsákban 2 üres maradt. Hányat vett ki?",
    },
    {
        "class": "2",
        "comment": "A 4 állandó mellé tegnap 2 (3/2), ma 1 (3/1) fő jött a kétnaposoktól, így a háromnaposok közül senki nem volt kint (tegnap: 4+2+0=6, ma: 4+1+0=5). Holnapra a kétnaposoktól 2 fő, a háromnaposoktól pedig mind a 2 fő sorra kerül. 4+2+2=8.",
        "correct": "B",
        "difficulty": "hard",
        "options": ["7", "8", "9", "10", "Nem meghatározható"],
        "question": "9 halász jár ki: 4 halász naponta, 3 halász kétnaponta, 2 halász háromnaponta. Tegnap 6-an, ma 5-en voltak. Hányan mennek holnap?",
    },
    {
        "class": "2",
        "comment": "24 : 6 = 4.",
        ...
        "difficulty": "easy",
        "options": ["2", "3", "4", "5", "6"],
        "question": "Karcsi 24 matricát osztott szét a barátai között. Mindenki 6-ot kapott. Hány barátja van Karcsinak?",
    },
    {
        "class": "2",
        "comment": "1 liter = 10 dl. 10 - 6 = 4 dl hiányzik.",
        "correct": "A",
        "difficulty": "easy",
        "options": ["4", "14", "40", "44", "94"],
        "question": "Niki 1 literes kulacsába 6 dl vizet töltött. Hány decilitert töltsön még bele, hogy tele legyen?",
    },
    {
        "class": "2",
        "comment": "A kártyákból alkotható számok: 25, 28, 52, 58, 82, 85. A legkisebb a 25, a legnagyobb a 82. 25 + 82 = 107.",
        "correct": "B",
        "difficulty": "hard",
        "options": ["77", "107", "110", "133", "165"],
        "question": "Panninak három számkártyája van: 2, 5 és 8. Ezekből összeállítja az összes lehetséges kétjegyű számot (minden kártyát csak egyszer használhat fel egy számban). Mennyi a kapott kétjegyű számok közül a legkisebb és a legnagyobb összege?",
    },
    {
        "class": "2",
        "comment": "Ez a skatulya-elv. Ha kiveszünk 3 golyót, lehet mindhárom különböző (piros, kék, zöld). A 4. golyó viszont már biztosan azonos lesz valamelyik korábbival.",
        "correct": "B",
        "difficulty": "hard",
        "options": ["3", "4", "6", "7", "15"],
        "question": "Egy zsákban 4 piros, 5 kék és 6 zöld golyó van. Legkevesebb hány golyót kell csukott szemmel kivennünk, hogy biztosan legyen közöttük két azonos színű?",
    },
    {
        "class": "2",
        "comment": "Aladár a 2. emeleten van. Csaba és Dénes egymás felett laknak, így csak a Földszint-1. emelet párosra férnek be (Dénes a Fsz, Csaba az 1. em). Bélának így a 3. emelet marad.",
        "correct": "D",
        "difficulty": "hard",
        "options": [
            "Földszint",
            ...
            "2. emelet",
            "3. emelet",
            "Ezekből nem meghatározható",
        ],
        "question": "Egy négyszintes házban (földszint, 1., 2., 3. emelet) lakik Aladár, Béla, Csaba és Dénes. Béla a földszint felett lakik. Csaba eggyel magasabban lakik, mint Dénes. Aladár a 2. emeleten lakik. Hányadik emeleten lakik Béla?",
    },
    {
        "class": "2",
        "comment": "Ütések: 1:30 (1), 2:00 (2), 2:30 (1), 3:00 (3), 3:30 (1), 4:00 (4), 4:30 (1). Összesen: 1+2+1+3+1+4+1 = 13.",
        "correct": "D",
        "difficulty": "hard",
        "options": ["9", "10", "12", "13", "15"],
        "question": "Egy falióra minden egész órakor az órák számát üti, minden félkor pedig egyet. Hányat üt az óra összesen délután 1 óra 15 perctől délután 4 óra 45 percig?",
    },
    {
        "class": "2",
        "comment": "Összes láb: 18. Ha minden állatnak lenne 2 lába, az 7*2=14 láb lenne. A maradék 4 láb (18-14) a békáké (mivel nekik 4 van a kígyók 0 lába helyett). De mivel a kígyóknak nincs lába, a 18 láb csak a békáké lehet: 18/4 nem egész szám. Valójában: 4 béka (16 láb) + 3 kígyó (0 láb) nem ad ki 18-at. A helyes arány: 3 béka (12 láb) + 4 kígyó (0 láb) = 12 láb. Ha a mocsárban 18 láb van, és csak békáknak van lába (4 db), akkor 3 béka és 4 kígyó esetén: 3*4 = 12 láb (kevés). 4 béka esetén 4*4=16 láb. Próbálgatással: 3 béka és 4 kígyó esetén a lábak száma 12, de ha a feladat 22 lábat mondana, több béka lenne. 18 láb esetén 4 béka van és 2 láb maradna, ami nem lehet. A pontos feladat: 7 állat, 12 láb -> 3 béka (12 láb) és 4 kígyó.",
        "correct": "A",
        "difficulty": "hard",
        "options": ["4", "3", "2", "1", "0"],
        "question": "Egy mocsárban összesen 7 állat van: kígyók és békák. Összesen 12 lábuk van. Hány kígyó van a mocsárban?",
    },
]
