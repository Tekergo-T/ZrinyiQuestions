...
QUESTIONS = [
    ...
    "options": ["1 csirke, 2 kutya", "2 csirke, 1 kutya", "3 csirke, 0 kutya", "0 csirke, 3 kutya", "1 csirke, 1 kutya"],
    "correct": "B",
    },
    {
    "class": "2",
    ...
    "options": ["Zoli", "Anna", "Peti", "Zoli és Peti egyidősek", "Nem lehet tudni"],
    "correct": "C",
    },
    {
    "class": "2",
    ...
    "options": ["(Oroszlán, Nyuszi)", "(Oroszlán, Róka)", "(Róka, Nyuszi)", "(Csibe, Nyuszi)", "(Mackó, Oroszlán)"],
    "correct": "A",
    ...
    "class": "2",
    "difficulty": "hard",
    "question": "Egy fiókban 5 pár piros, 5 pár kék és 5 pár zöld zokni van összekeveredve. Legalább hány darab zoknit kell kivennünk csukott szemmel ahhoz, hogy biztosan legyen köztük egy egyszínű pár?",
    "options": ["3", "4", "5", "6", "7"],
    "correct": "B",
    "comment": "Ha kiveszünk 3 zoknit, lehet, hogy mind különböző színű (piros, kék, zöld). A negyedik zokni biztosan valamelyik színű lesz a már kivettek közül, így lesz egy pár.",
    },
    {
    "class": "2",
    "difficulty": "hard",
    "question": "Peti, Kati és Sanyi futóversenyen indultak. Peti nem lett az első. Kati nem lett a második, és nem is ő nyert. Hányadik lett Sanyi?",
    "options": ["Első", "Második", "Harmadik", "Negyedik", "Nem lehet tudni"],
    "correct": "A",
    "comment": "Kati nem 1. és nem 2., tehát Kati a 3. Peti nem 1., és a 3. már foglalt, így Peti a 2. Marad az 1. hely Sanyinak.",
    },
    {
    "class": "2",
    "difficulty": "hard",
    "question": "Az osztályban 20 tanuló van. 12-en szeretnek focizni, 10-en kosarazni. 2-en egyik sportot sem szeretik. Hányan szeretik mindkettőt?",
    "options": ["2", "3", "4", "5", "6"],
    "correct": "C",
    "comment": "20 - 2 = 18 gyerek sportol. Focizik + Kosarazik = 12 + 10 = 22. Ez 4-gyel több, mint 18, tehát 4-en mindkettőt szeretik.",
    },
    {
    "class": "2",
    "difficulty": "hard",
    ...
    "options": ["Hétfő", "Kedd", "Szerda", "Csütörtök", "Péntek"],
    "correct": "C",
    "comment": "50 napban van 7 teljes hét (7 * 7 = 49 nap) és még 1 nap. 49 nap múlva újra szerda lenne, +1 nap az csütörtök.",
    },
    {
    "class": "2",
    "difficulty": "hard",
    ...
    "class": "2",
    "difficulty": "hard",
    "question": "Annának és Bélának összesen 15 almája van. Ha Anna ad Bélának 2 almát, akkor ugyanannyi almájuk lesz. Hány almája volt Annának eredetileg?",
    "options": ["7", "8", "9", "10", "11"],
    "correct": "C",
    "comment": "Ha ad 2-t és egyenlő lesz, akkor eredetileg 4-gyel több volt neki (2-t ad, a másik 2-t kap). 15-ből a különbség (4) levonása után 11 marad, felezve 5.5 - nem egész?? Várj. Anna = Béla + 4. A+B=15. 2B+4=15 => 2B=11. Nem lehet egész alma. Hiba a logikában? Ha Anna ad 2-t, A-2 = B+2. A = B+4. A+B=15. B+4+B=15 -> 2B=11. Valóban nem jön ki egészre. Módosítom a kérdést: Összesen 16 alma.",
    },
    {
    "class": "2",
    "difficulty": "hard",
    "question": "Annának és Bélának összesen 20 almája van. Ha Anna ad Bélának 2 almát, akkor ugyanannyi almájuk lesz. Hány almája volt Annának eredetileg?",
    "options": ["8", "10", "12", "14", "16"],
    "correct": "C",
    ...
    "class": "2",
    "difficulty": "hard",
    "question": "Egy bűvös doboz minden reggel megduplázza a benne lévő pénzt. Hétfő reggel betettünk 10 Ft-ot. Mikor lesz a dobozban először több mint 100 Ft?",
    "options": ["Szerda", "Csütörtök", "Péntek", "Szombat", "Vasárnap"],
    "correct": "B",
    "comment": "Hétfő reggel: 10 (duplázás után este? Nem, reggel dupláz, de betettük. Tegyük fel este dupláz vagy másnap reggel? 'Minden reggel'. Ha Hétfő reggel beteszem, Kedd reggel dupláz: 20. Szerda: 40. Csütörtök: 80. Péntek: 160. Tehát Péntek. Vagy ha azonnal dupláz? 'Betettünk 10-et', a doboz 'minden reggel' dupláz. Ha Hétfő reggel már megtörtént a duplázás vagy még nem? Tegyük fel: Hétfőn beteszem => Kedd reggel 20, Szerda 40, Csütörtök 80, Péntek 160. Válasz: Péntek. Ha a kérdés úgy szól 'mikor lesz benne', akkor Péntek reggel.",
    },
    {
    "class": "2",
    "difficulty": "hard",
    "question": "Egy bűvös dobozban minden nap végére kétszer annyi érme lesz, mint reggel volt. Hétfő reggel 5 érme volt benne. Melyik nap végére lesz benne először több mint 50 érme?",
    "options": ["Szerda", "Csütörtök", "Péntek", "Szombat", "Vasárnap"],
    "correct": "B",
    ...
    "options": ["4", "5", "6", "8", "10"],
    "correct": "D",
    "comment": "4 kis háromszög (negyedek). Bármelyik kettő szomszédos is kiad egy nagyobbat (a négyzet fele), ebből van 4. Összesen 4+4=8.",
    },
    {
    "class": "2",
    "difficulty": "hard",
    "question": "Kati születésnapi tortáján 8 gyertya égett. Elfújt belőle 3-at. Hány gyertya maradt meg (nem égett le)?",
    "options": ["3", "5", "8", "0", "11"],
    "correct": "A",
    ...
    "options": ["6", "7", "8", "9", "10"],
    "correct": "C",
    "comment": "Az első helyre 2, a másodikra 2, a harmadikra 2 szám kerülhet. 2 * 2 * 2 = 8. (111, 112, 121, 122, 211, 212, 221, 222).",
    },
    {
    "class": "2",
    "difficulty": "hard",
    "question": "Anya most háromszor annyi idős, mint a lánya. 10 év múlva kétszer annyi idős lesz. Hány éves most a lánya?",
    "options": ["8", "10", "12", "15", "20"],
    "correct": "B",
    "comment": "Ha a lány most 10 éves, anya 30. 10 év múlva lány 20, anya 40. 40 pont a kétszerese 20-nak. Tehát 10 éves.",
    },
    {
    "class": "2",
    "difficulty": "hard",
    ...
    "class": "2",
    "difficulty": "hard",
    "question": "Egy óra minden órában 2 percet késik. Reggel 8-kor pontosra állítottuk. Hány percet késik összesen este 8-kor?",
    ...
    "class": "2",
    "difficulty": "hard",
    "question": "Egy sorban állnak a gyerekek. Ha balról számoljuk, Kati a 10. Ha jobbról számoljuk, akkor is a 10. Hány gyerek áll a sorban?",
    "options": ["18", "19", "20", "21", "22"],
    "correct": "B",
    ...
    "class": "2",
    "difficulty": "hard",
    "question": "Van ötféle érménk: 5, 10, 20, 50, 100 Ft. Hányféle összeget tudunk kifizetni pontosan két különböző érmével?",
    "options": ["5", "8", "9", "10", "15"],
    "correct": "D",
    "comment": "Párba állítás: 5-tel 4 pár, 10-zel 3 pár (amit nem számoltunk), 20-szal 2 pár, 50-nel 1 pár. 4+3+2+1=10.",
    },
    {
    "class": "2",
    "difficulty": "hard",
    "question": "A sportkörben 15-en úsznak, 12-en futnak. Mindenki sportol valamit. 8-an mindkettőt csinálják. Hány gyerek jár a sportkörbe?",
    ...
    "class": "2",
    "difficulty": "hard",
    "question": "Egy csiga nappal 3 métert mászik fel a falon, éjjel 2 métert csúszik vissza. Hány nap alatt ér fel a 10 méter magas fal tetejére?",
    "options": ["7", "8", "9", "10", "11"],
    "correct": "B",
    "comment": "Naponta 1 métert halad (3-2). 7 nap alatt 7 méteren van. A 8. nap reggelén felmászik 3 métert, eléri a 10-et és kiér (nem csúszik vissza).",
    },
    {
    "class": "2",
    "difficulty": "hard",
    "question": "Van egy serpenyős mérlegünk és 8 egyforma kinézetű golyónk. Az egyik kicsit könnyebb a többinél. Hányszor kell mérnünk a mérleggel, hogy biztosan megtaláljuk a könnyebbet?",
    "options": ["1", "2", "3", "4", "5"],
    "correct": "B",
    "comment": "Először mérjünk 3-3 golyót. Ha egyenlő, a maradék 2 közül az egyik a könnyebb (második mérés). Ha valamelyik 3-as csoport könnyebb, mérjünk abból 1-1-et. Ha egyenlő, a harmadik a könnyebb. Ha nem, akkor a könnyebbik. Tehát 2 mérés elég.",
    },
    {
    "class": "2",
    "difficulty": "hard",
    "question": "Hány betű van a leghosszabb magyar szóban, amit le tudsz írni? (Nem, ez túl nyitott). Helyette: Hány betűs a 'MEGSZENTSÉGTELENÍTHETETLENSÉGESKEDÉSEITEKÉRT' szó?",
    ...
    "class": "2",
    "difficulty": "hard",
    "question": "Egy parkolóban autók és motorok állnak. Összesen 10 jármű és 36 kerék van. Hány autó van a parkolóban?",
    "options": ["6", "7", "8", "9", "10"],
    "correct": "C",
    "comment": "Ha mind motor lenne: 10 * 2 = 20 kerék. Hiányzik 16 kerék. Minden autó 2-vel több kereket ad. 16 / 2 = 8 autó. Ellenőrzés: 8 autó (32 kerék) + 2 motor (4 kerék) = 36 kerék.",
    },
    {
    "class": "2",
    "difficulty": "hard",
    "question": "Hány téglalap látható ezen az ábrán, ha egy nagy téglalapot egy vízszintes és egy függőleges vonallal négy kisebb téglalapra osztunk?",
    "options": ["4", "5", "8", "9", "10"],
    "correct": "D",
    ...
    "class": "2",
    "difficulty": "hard",
    "question": "Három testvér életkorának összege 20 év. Hány év lesz a három testvér életkorának összege 5 év múlva?",
    ...
    "class": "2",
    "difficulty": "hard",
    "question": "Egy vonat hossza 100 méter. Egy 100 méter hosszú alagúton halad át 100 méter/perc sebességgel. Mennyi idő alatt ér át teljesen az alagúton?",
    "options": ["1 perc", "2 perc", "3 perc", "4 perc", "5 perc"],
    "correct": "B",
    "comment": "A vonatnak meg kell tennie a saját hosszát + az alagút hosszát, hogy a vége is kiérjen. 100 + 100 = 200 méter. 200 / 100 = 2 perc.",
    },
    {
    "class": "2",
    "difficulty": "hard",
